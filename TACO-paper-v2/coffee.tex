...
available. Our optimization strategy is rather based on heuristics and a simple
cost model, as described later.

Once received an AST from FFC, an ordered sequence of optimization steps are executed. Application of
