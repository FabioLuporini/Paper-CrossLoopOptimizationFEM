...
parallelism, redundant computation, and register locality. How such transformations generalize
to domains other than local assembly will also be discussed.
...
\begin{enumerate}
 ...
 \item An investigation of their applicability to different computational
 domains.  
\end{enumerate}
...
Section~\ref{sec:related-work}. The generality of our optimization strategy
and the applicability to other domains is discussed in Section~\ref{sec:generality}. 
Finally, Section~\ref{sec:conclusions} reviews our contributions in the light 
