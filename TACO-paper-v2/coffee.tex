...
Only relatively small meshes can fit a GPU memory, and distributed execution is minimally
supported by available frameworks (if any). There has been some research on
...
(ii) testing only very low order methods, (iii) not optimizing for
