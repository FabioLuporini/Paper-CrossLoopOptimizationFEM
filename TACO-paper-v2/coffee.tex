...
optimization strategy. The \texttt{icc 13.1} compiler was used. For what concerns the compilation flags, we selected the best optimization levels on each platform: \texttt{-O2}, and \texttt{-xAVX} for auto-vectorization, were used on the Sandy Bridge; \texttt{-O3} was adopted on the Xeon Phi. 
