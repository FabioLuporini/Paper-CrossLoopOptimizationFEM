...
\subsection{Domain-driven Loop-invariant Code Motion}
...
\subsection{Domain-drive Optimization of Register Management}
...
%In addition, register locality would be affected, since the same matrix could appear in a number of products.

%The problem is time-dependent, so , which intuitively increaes the computation cost. 

%Also, our results prove that current vendor compilers still have notable limitations, despite optimizing loop nests that are 1) affine, 2) have no stencil, and 3) ?

%\begin{table}[h]
%\begin{tabulary}{1.0\columnwidth}{|C|C|}
%\hline
%Problem & shape & p & original & $licm$ & $licm$ \\\hline\hline
%Auto-vectorizable Loop-invariant code motion ($licm$) &   \\ \hline
%Padding &  \\ \hline
%Data Alignment & \\ \hline
%Loop interchange      & loops  \\ \hline
...
\begin{tabularx}{1.0\textwidth}{c|XX|XX|XX|XX|}
\cline{2-9}
& \multicolumn{2}{c|}{$n_f=1$} & \multicolumn{2}{c|}{$n_f=2$} & \multicolumn{2}{c|}{$n_f=3$} & \multicolumn{2}{c|}{$n_f=4$} \\
\cline{2-9}
& A & Tensor& A & Tensor& A & Tensor& A & Tensor\\
\hline
\multicolumn{1}{|c|}{$p=1,q=1$} & $6.89e{-}17$ & $9.30e{-}17$ & $5.49e{-}17$ & $4.95e{-}17$ & $1.44e{-}17$ & $1.34e{-}17$ & $1.56e{-}17$ & $\mathbf{4.43e{-}5}$ \\
\multicolumn{1}{|c|}{$p=1,q=2$} & $6.80e{-}17$ & $1.56e{-}16$ & $1.22e{-}16$ & $7.14e{-}17$ & $1.17e{-}17$ & $1.27e{-}17$ & $8.05e{-}18$ & $\mathbf{9.77e{-}5}$ \\
\multicolumn{1}{|c|}{$p=1,q=3$} & $8.16e{-}17$ & $8.94e{-}17$ & $6.21e{-}17$ & $\mathbf{6.77e{-}5}$ & $2.44e{-}17$ & $\mathbf{7.69e{-}4}$ & $8.61e{-}17$ & $\mathbf{5.02e{-}4}$ \\
\multicolumn{1}{|c|}{$p=1,q=4$} & $3.70e{-}16$ & $\mathbf{1.83e{-}4}$ & $7.12e{-}16$ & $\mathbf{4.11e{-}4}$ & $2.65e{-}16$ & $\mathbf{5.42e{-}4}$ & $5.03e{-}16$ & $\mathbf{4.36e{-}4}$ \\
\hline
\multicolumn{1}{|c|}{$p=2,q=1$} & $2.42e{-}16$ & $2.34e{-}16$ & $1.18e{-}16$ & $3.42e{-}17$ & $2.78e{-}17$ & $\mathbf{1.30e{-}4}$ & $1.22e{-}16$ & $\mathbf{3.06e{-}4}$ \\
\multicolumn{1}{|c|}{$p=2,q=2$} & $4.50e{-}16$ & $1.47e{-}16$ & $7.47e{-}17$ & $\mathbf{7.04e{-}5}$ & $4.05e{-}16$ & $\mathbf{6.47e{-}4}$ & - & - \\
\multicolumn{1}{|c|}{$p=2,q=3$} & $1.85e{-}16$ & $\mathbf{1.65e{-}4}$ & $7.76e{-}16$ & $\mathbf{5.57e{-}4}$ & $1.88e{-}15$ & $\mathbf{1.47e{-}3}$ & - & - \\
\multicolumn{1}{|c|}{$p=2,q=4$} & $2.22e{-}15$ & $\mathbf{2.90e{-}4}$ & $4.01e{-}15$ & $\mathbf{1.42e{-}3}$ & - & - & - & - \\
\hline
\multicolumn{1}{|c|}{$p=3,q=1$} & $6.54e{-}17$ & $5.96e{-}17$ & $8.13e{-}17$ & $\mathbf{9.70e{-}5}$ & - & - & - & - \\
\multicolumn{1}{|c|}{$p=3,q=2$} & $9.43e{-}17$ & $1.26e{-}16$ & $8.99e{-}16$ & $\mathbf{5.23e{-}4}$ & - & - & - & - \\
\multicolumn{1}{|c|}{$p=3,q=3$} & $2.27e{-}16$ & $\mathbf{2.86e{-}4}$ & $5.77e{-}15$ & $\mathbf{1.81e{-}3}$ & - & - & - & - \\
\multicolumn{1}{|c|}{$p=3,q=4$} & $2.45e{-}15$ & $\mathbf{5.31e{-}4}$ & $1.62e{-}14$ & $\mathbf{2.54e{-}3}$ & - & - & - & - \\
\hline
\end{tabularx}
}
\begin{figure*}
