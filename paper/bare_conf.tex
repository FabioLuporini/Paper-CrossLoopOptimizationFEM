...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/helmholtz-normalized-opvect.pdf}
...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/helmholtz-normalized-opvect-phi.pdf}
...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/diffusion-normalized-opvect.pdf}
...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/diffusion-normalized-opvect-phi.pdf}
...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/burgers-normalized-split.pdf}
...
\begin{figure}[h]
\includegraphics[scale=0.67]{Pictures/burgers-normalized-split-phi.pdf}
