...
Our experiments show that the original generated code for non-trivial assembly kernels is sub-optimal. Our cost-model-driven sequence of code transformations, aimed at improving SIMD vectorization and register data locality, can result in performance improvements up to 4.4$\times$ over original kernels. The contributions of this paper are
\begin{enumerate}
